...
import { setChangedValue, setCurrentQuestion, setCurrentAnswer } from "../actions/pricing";
import * as actionTypes from '../actions/types';
import { getState } from '../selectors/pricing';
...
export const pricing = [
    takeLatest(actionTypes.PRICING_CHANGE_HANDLER, changeHandler),
    takeLatest(actionTypes.PRICING_BACK_BUTTON_HANDLER, backHandler),
    takeLatest(actionTypes.PRICING_NEXT_BUTTON_HANDLER, nextHandler),
]