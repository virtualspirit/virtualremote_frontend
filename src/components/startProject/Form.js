            ...
            <div className="form-section-div">
                <form className="form-section-form" >
                    <div className="all-input-btn">
                        ...
                        <p className="input-label extra-mar-tp">Industry <span className="requr-star">*</span></p>
                        ...
                        <p className="input-label">Estimated budget <span className="requr-star">*</span></p>
                        ...
                        <p className="input-label">Describe your project <span className="requr-star">*</span></p>
